...
export const BootcampAccordionCard = () => {
  return (
    <div className="relative flex w-full flex-col items-center gap-5 px-5 py-10 sm:flex-row sm:items-stretch sm:justify-center md:gap-10">
      <Card className="relative flex flex-col w-80 overflow-hidden border border-white/10 bg-black/40 px-4 py-8 text-white shadow-2xl backdrop-blur-md transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_0_40px_rgba(59,130,246,0.2)] sm:w-96">
        <div className="absolute -left-10 -top-10 h-32 w-32 rounded-full bg-blue-500/20 blur-3xl" />
        <div className="relative z-10 text-2xl font-bold text-blue-300 drop-shadow-md lg:text-3xl">기초반</div>
        <div className="relative z-10 flex-1 py-6 text-slate-300">
          코딩을 처음 접하거나 문법부터 응용까지 기초를 단단히 다지고 싶은
          준회원 분들이 선택할 수 있습니다.
        </div>
        <Accordion type="single" collapsible className="relative z-10 w-full text-white">
          <AccordionItem
            value="item-1"
